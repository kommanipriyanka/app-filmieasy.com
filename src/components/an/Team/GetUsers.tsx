          ...
          <div className="w-64 border-r border-zinc-800/30 bg-black/20 backdrop-blur-sm flex flex-col">
                    ...
                    <button
                      ...
                      className={`w-full text-left h-[42px] px-2.5 rounded-lg text-[13px] flex justify-between items-center transition-all ${
                        isDepartmentSelected(dept.name)
                          ...
                          : "text-zinc-500 hover:bg-zinc-900/50 hover:text-zinc-400"
                      }`}
                    >
            ...
            <div className="p-3 border-t border-zinc-800/30">
              <button
                ...
                className="w-full h-10 flex items-center justify-center gap-2 px-3 bg-zinc-900/50 hover:bg-zinc-900 border border-zinc-800/50 rounded-lg text-[13px] font-normal text-zinc-400 transition-colors"
              >
          ...
          <div className="flex-1 flex flex-col bg-black ml-4">
            <div className="h-[52px] border-b border-zinc-800/30 px-6 flex items-center justify-between bg-[#0a0a0a]">
              <div className="flex items-center">
                <span className="text-sm font-normal text-zinc-400">All </span>
              ...
              <div className="flex items-center gap-2">
                <div className="relative">
                  ...
                  >
                    <SelectTrigger className="w-[180px] h-9 bg-zinc-900/50 border border-zinc-800/50 text-xs">
                ...
                <div className="relative">
                  <Calendar className="absolute left-3 top-1/2 transform -translate-y-1/2 w-3.5 h-3.5 text-zinc-600" />
                  <Input
                    type="date"
                    value={selectedDate}
                    onChange={(e) => setSelectedDate(e.target.value)}
                    className="h-9 pl-9 pr-3 bg-zinc-900/50 border border-zinc-800/50 rounded-lg text-xs text-white focus:outline-none focus:ring-1 focus:ring-zinc-700 focus:border-zinc-700 w-[180px]"
                  />
                </div>
                <div className="relative">
                  ...
                  <input
                    ...
                    className="h-9 pl-9 pr-3 bg-zinc-900/50 border border-zinc-800/50 rounded-lg text-xs text-white placeholder-zinc-600 focus:outline-none focus:ring-1 focus:ring-zinc-700 focus:border-zinc-700 w-[180px]"
                  />
                </div>
                <button className="h-9 flex items-center gap-2 px-3.5 bg-zinc-900/50 border border-zinc-800/50 rounded-lg text-xs font-normal text-zinc-400 hover:bg-zinc-900 transition-colors">
                ...
                <button onClick={()=>{console.log("cleick"); navigate({to:"/team/add-user"})}} className="h-9 flex items-center gap-2 px-4 bg-blue-600 hover:bg-blue-700 rounded-lg text-xs font-medium text-white transition-colors">
