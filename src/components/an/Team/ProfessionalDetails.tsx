      ...
      <div className="space-y-6">
        <div className="bg-zinc-900/40 backdrop-blur-sm border border-zinc-800/50 rounded-lg p-6">
          ...
          <div className="space-y-5">
            ...
            <div>
              <Label className="text-xs text-zinc-400 mb-2 block">Experience</Label>
              <div className="flex gap-2">
                <Input
                  type="number"
                  value={formData.experience}
                  onChange={(e) => onUpdate({ experience: e.target.value })}
                  className="flex-1 bg-black/40 border-zinc-800/50 text-white h-10 text-sm placeholder:text-zinc-600"
                  placeholder="Enter Experience"
                />
                <Select defaultValue="years">
                  <SelectTrigger className="w-28 bg-black/40 border-zinc-800/50 text-white h-10 text-sm">
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent className="bg-zinc-900 border-zinc-800">
      ...
      <div className="space-y-6">
        <div className="bg-zinc-900/40 backdrop-blur-sm border border-zinc-800/50 rounded-lg p-6">
          ...
          <div className="space-y-5">
            ...
            <div>
              <Label className="text-xs text-zinc-400 mb-2 block">Block Dates</Label>
                  ...
                  <PopoverTrigger asChild>
                    <Button
                      ...
                      className={cn(
                        ...
                        !formData.blockFrom && "text-zinc-500"
                      )}
                    >
                ...
                <Popover>
                  <PopoverTrigger asChild>
                    <Button
                      ...
                      className={cn(
                        "w-full justify-start text-left font-normal bg-black/40 border-zinc-800/50 h-10 text-sm hover:bg-black/60",
                        !formData.blockTo && "text-zinc-500"
                      )}
                    >
                      <CalendarIcon className="mr-2 h-4 w-4 text-teal-400" />
