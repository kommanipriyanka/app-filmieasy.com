              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <label
                    ...
                    className="w-24 h-24 bg-zinc-700/30 rounded-lg border-zinc-800/50 flex items-center justify-center cursor-pointer hover:bg-zinc-700/50 transition-colors"
                  >
